    ...
    return (
        ...
        >
            <div className="container mx-auto flex flex-col justify-between min-h-screen lg:pt-0 pt-24">
                <div className="flex flex-col items-center justify-center text-center gap-y-4 pt-[10%]"data-aos="zoom-in-left"
      data-aos-duration="1000">
                ...
                <div className="flex flex-col items-center justify-center text-center" data-aos="zoom-in-right"
      data-aos-duration="1000">
                    <p>THE ANCIENT</p>
