...
export default function About() {
  return (
    <div        
    id="about" className="bg-[#FF4500] relative "
    >
        ...
        >
            ...
            <section className="lg:flex py-[10%] justify-center gap-x-[10%]" >
                <div className="text-white lg:w-1/4" data-aos="fade-right"
                ...
                >
                  {/* <div className="linear-gradient absolute h-full w-full "></div> */}
                    <img 
                    src="/Matsya.jpg" alt="Matsya Avatar"
            ...
            <section className="lg:flex py-[10%] justify-center gap-x-[10%]">
                <div className="text-white lg:w-1/4" data-aos="fade-left"
                ...
                <div className="relative lg:h-[25rem] h-[230px] lg:w-[25rem] w-[230px] lg:mx-0 mx-auto" data-aos="fade-right"
                data-aos-duration="2000">
                  {/* <div className="linear-gradient absolute h-full w-full "></div> */}
            ...
            <div className="flex lg:flex-row flex-col-reverse pt-[10%] pb-[5%] justify-center gap-x-[10%]">
              <div className="relative lg:h-[25rem] h-[250px] lg:w-[25rem] w-[250px] lg:mx-0 mx-auto lg:py-0 justify-center items-center" data-aos="fade-right"
                data-aos-duration="2000">
                {/* <div className="linear-gradient absolute h-full w-full "></div> */}
